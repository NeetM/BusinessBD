CREATE DATABASE Empresa4D_Marlon;
Use Empresa4D_Marlon;
...
INSERT INTO Comuna (Com_ID, Com_Nombre) values (1,'Arica'),
			(2,'Camarones'),
			(3,'Iquique'),
			(4,'Pica'),
			(5,'Pozo Almonte'),
...
INSERT INTO Cargo (Crg_ID, Crg_Nombre) Values
			(3,'Auxiliar'),
			(2,'Supervisor'),
			(1,'Directivo'),
			(4,'Profesional'),
...
INSERT INTO Empleado (Emp_Rut, Emp_Nombre, Emp_Apellido, Emp_ID_Cargo, Emp_Sueldo, Emp_ID_Comuna) Values
('10.285.852-5','Nelson','Soto',4,2091237,337),
            ...
            INSERT INTO Cliente (Cli_Rut, Cli_Nombre, Cli_Apellido, Cli_ID_Comuna) Values
            ('4.824.256-8','Marcela','Perez',200),
...
INSERT INTO Producto (Prd_ID, Prd_Nombre) Values
			(1001,'VideoGrabador'),
			(1002,'Microondas'),
			(1003,'Televisor 21"'),
			(1004,'Centrifuga'),
...
INSERT INTO ProductoCliente (Pcl_Cli_Rut, Pcl_ID_Prod, Pcl_Fecha_Entrega, Pcl_Saldo) Values
('7.091.874-4',1002,'2016-5-23',78035),
